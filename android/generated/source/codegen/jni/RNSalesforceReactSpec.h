...
public:
  NativeSFMobileSyncReactBridgeSpecJSI(const JavaTurboModule::InitParams &params);
};
...
public:
  NativeSFNetReactBridgeSpecJSI(const JavaTurboModule::InitParams &params);
};
...
public:
  NativeSFOauthReactBridgeSpecJSI(const JavaTurboModule::InitParams &params);
};
...
public:
  NativeSFSmartStoreReactBridgeSpecJSI(const JavaTurboModule::InitParams &params);
};
